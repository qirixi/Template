            ...
            <div id="pad-wrapper" class="users-list">
                ...
                <div class="row-fluid table">
                    <table class="table table-hover">
                        ...
                        <tr class="first">
                            <td>
                                <img src="<?php echo base_url();?>img/contact-img.png" class="img-circle avatar hidden-phone" />
                        ...
                        <tr>
                            <td>
                                <img src="<?php echo base_url();?>img/contact-img2.png" class="img-circle avatar hidden-phone" />
                                <a href="user-profile.html" class="name">Alejandra Galvan Castillo</a>
                                <span class="subtext">Graphic Design</span>
                            </td>
                            <td>
